...
while escolhaMenu == 0:
    ...
    voto = 0 #VOTOS ZERADOS PARA RECEBER OS NOVOS VOTOS
...
########################################################################################
        ...
        while escolhaMenu == 2:
            ...
            listaVoto = [] #LISTA ZERADA PARA RECEBER OS NOVOS VOTOS
...
if escolhaMenu == 3:
    ...
    print(f'''\n{formatacao:6}{'Nulos':17}{'--':16}{'--'}{nulo:12}{(100 * nulo) / (votoValido + branco + nulo):13.2f}
      {'Brancos':17}{'--':16}{'--'}{nulo:12}{(100 * branco) / (votoValido + branco + nulo):13.2f}
        ''')
