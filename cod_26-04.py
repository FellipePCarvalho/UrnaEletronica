...
while escolhaMenu != 0:
    ...
    while True:
        ...
        # ESCOLHA // GERAR RELATÓRIO //
            ...
            for contQtdCandi in range(0, quantCandiCadastr):
                print(f'\n{formatacao:6}{listaNomes[contQtdCandi]:16} {listaPartidos[contQtdCandi]:15} {listaNumeros[contQtdCandi]:<12} {listaVoto[contQtdCandi]:<6}', end=" ")
                contQtdCandi += 1  # SOMANDO UM A QUANTIDADE DE CANDIDATOS CADASTRADOS
...
if escolhaMenu == 3:
    ...
    for contQtdCandi in range(0, quantCandiCadastr):
        ...
        if votoValido > 0:
            ...
            print(f'\n{formatacao:6}{listaNomes[contQtdCandi]:16} {listaPartidos[contQtdCandi]:15} {listaNumeros[contQtdCandi]:<12} {listaVoto[contQtdCandi]:<11}'
                f' {porcentagemValidos:<14.2f} {porcentagemTotal:<6.2f}', end=" ")
            contQtdCandi += 1  # SOMANDO UM A QUANTIDADE DE CANDIDATOS CADASTRADOS
    ...
    print(f"\n{formatacao:6}{'Nulos':17}{'--':16}{'--':13}{nulo:<12}{'--':<15}{porcentagemNulo:<10.2f}")
    print(f"{formatacao:6}{'Brancos':17}{'--':16}{'--':13}{branco:<12}{'--':<15}{porcentagemBranco:<10.2f}")
    print('\n')
...
#CIÊNCIA DE DADOS - 1ºSEM
#FELLIPE PIRES DE CARVALHO
